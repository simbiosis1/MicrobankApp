 ...
 */
@WebServlet("/getLoanTransIdByRef")
public class GetLoanTransIdByRef extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetLoanTransIdByRef() {
		super();
	}
	...
	String processData(String key, String data) {
		Long id = iLoanBp.getLoanTransIdByRef(key, Long.parseLong(data));
