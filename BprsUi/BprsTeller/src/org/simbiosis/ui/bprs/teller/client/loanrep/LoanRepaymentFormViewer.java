...
public class LoanRepaymentFormViewer extends FormWidget implements
		Editor<TransactionDv>, ILoanRepayment {

	Activity activity;

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	interface MyUiBinder extends UiBinder<Widget, LoanRepaymentFormViewer> {
	}

	interface Driver extends SimpleBeanEditorDriver<TransactionDv, LoanRepaymentFormViewer> {
	}
	...
	public LoanRepaymentFormViewer() {
