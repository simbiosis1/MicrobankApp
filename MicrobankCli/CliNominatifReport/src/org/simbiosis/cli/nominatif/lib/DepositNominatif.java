...
public class DepositNominatif {
	...
	public class WriterThread implements Runnable {
		...
		public void run() {
			for (String sid : ids) {
				jsonReport.sendRawData("createDailyDeposit", strDate, sid);
	...
	public DepositNominatif(MicrobankCoreClient jsonMain,
	...
	public void execute() {
		System.out.println("Delete deposit nominatif...");
		jsonReport.sendRawData("deleteDailyDeposit", strDate);
