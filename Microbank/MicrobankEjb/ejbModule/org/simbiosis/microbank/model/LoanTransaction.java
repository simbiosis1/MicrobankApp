...
@NamedQueries({
		...
		@NamedQuery(name = "listLoanTransactionByRange1", query = "select x from LoanTransaction x where x.company=:company and x.direction=:direction and x.date>=:beginDate and x.date<=:endDate"),
		@NamedQuery(name = "listLoanTransactionByRange2", query = "select x from LoanTransaction x where x.branch=:branch and x.direction=:direction and x.date>=:beginDate and x.date<=:endDate"),
