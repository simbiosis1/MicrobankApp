...
@WebServlet("/listDepositRevSharing")
public class ListDepositRevSharing extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ListDepositRevSharing() {
		super();
	}
	...
	String processData(String key, String data) {
		...
		try {
			...
			List<DepositRevSharingDto> revenues = iRevenueBp
					.listDepositRevSharing(key, date);
