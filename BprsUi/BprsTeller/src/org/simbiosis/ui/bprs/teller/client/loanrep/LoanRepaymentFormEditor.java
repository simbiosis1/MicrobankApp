...
public class LoanRepaymentFormEditor extends FormWidget implements ILoanRepayment,
	...
	interface MyUiBinder extends UiBinder<Widget, LoanRepaymentFormEditor> {
	}

	interface Driver extends
			SimpleBeanEditorDriver<TransactionDv, LoanRepaymentFormEditor> {
	}
	...
	public LoanRepaymentFormEditor() {
