...
DIRNAME=`dirname "$0"`
PROGNAME=`basename "$0"`
APP_JAR=CliNominatifReport.jar
APP_CLASS=org.simbiosis.cli.nominatif.creator.CreatorDaily
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/SystemDto.jar:$APP_HOME/simbiosis/MicrobankDto.jar:$APP_HOME/simbiosis/GlDto.jar:$APP_HOME/simbiosis/Utils.jar:$APP_HOME/simbiosis/CliSimbiosis.jar"
