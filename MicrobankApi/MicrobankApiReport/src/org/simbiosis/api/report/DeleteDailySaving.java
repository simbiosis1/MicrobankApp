...
@WebServlet("/deleteDailySaving")
public class DeleteDailySaving extends WebApiReportServlet {
	...
	String processData(String key, String data) {
		...
		if (user != null) {
			...
			iSavingReport.deleteDailySaving(user.getCompany(), date);
		}
		return "";
	}
}
