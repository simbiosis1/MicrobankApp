...
public class Print {
	...
	public static void it(String docType, String style, Element element) {
		...
		it(docType, style, element.getString());
	}
	...
	public static void updateFieldsDOM(Element dom) {
		NodeList<com.google.gwt.dom.client.Element> textareas = dom
				.getElementsByTagName("textarea");
		NodeList<com.google.gwt.dom.client.Element> inputs = dom
				.getElementsByTagName("input");
		NodeList<com.google.gwt.dom.client.Element> options = dom
