...
@WebServlet("/saveVaultTellerTrans")
public class SaveVaultTellerTrans extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SaveVaultTellerTrans() {
		super();
	}
	...
	String processData(String key, String data) {
		...
		try {
			...
			iTellerBp.saveGlVaultTellerTrans(key, transDto);
		} catch (IOException e) {
			e.printStackTrace();
		}
		return result;
