...
public class Remedial12 extends FormWidget implements IRemedial12 {

	Activity activity;

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	interface MyUiBinder extends UiBinder<Widget, Remedial12> {
	}
	...
	public Remedial12() {
		...
		//
		all.addItem("Semua pembiayaan", "1");
		all.addItem("Pembiayaan punya tagihan", "0");
	}
