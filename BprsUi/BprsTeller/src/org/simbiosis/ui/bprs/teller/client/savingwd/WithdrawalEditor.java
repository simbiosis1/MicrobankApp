...
public class WithdrawalEditor extends FormWidget implements IWithdrawal,
	...
	interface MyUiBinder extends UiBinder<Widget, WithdrawalEditor> {
	}

	interface Driver extends
			SimpleBeanEditorDriver<TransactionDv, WithdrawalEditor> {
	}
