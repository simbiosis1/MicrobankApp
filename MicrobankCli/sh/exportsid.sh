...
DIRNAME=`dirname "$0"`
PROGNAME=`basename "$0"`
APP_JAR=SIDExport.jar
APP_CLASS=org.simbiosis.bi.sid.ExportSID
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/MicroBankDto.jar:$APP_HOME/simbiosis/SimbiosisUtils.jar:$APP_HOME/simbiosis/ReportingDto.jar"
