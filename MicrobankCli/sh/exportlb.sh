...
DIRNAME=`dirname "$0"`
PROGNAME=`basename "$0"`
APP_JAR=CliBIBprs.jar
APP_CLASS=org.simbiosis.cli.bi.lb.Labul
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/SystemDto.jar:$APP_HOME/simbiosis/GlIntf.jar:$APP_HOME/simbiosis/MicrobankDto.jar:$APP_HOME/simbiosis/MicrobankIntf.jar:$APP_HOME/simbiosis/CliSimbiosis.jar"
