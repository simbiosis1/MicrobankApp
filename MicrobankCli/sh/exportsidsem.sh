...
APP_CLASS=org.simbiosis.cli.bi.sid.ReadSID
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/SystemDto.jar:$APP_HOME/simbiosis/MicrobankDto.jar:$APP_HOME/simbiosis/MicrobankIntf.jar:$APP_HOME/simbiosis/CliSimbiosis.jar"
