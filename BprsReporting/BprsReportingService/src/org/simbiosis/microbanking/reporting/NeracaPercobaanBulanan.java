...
@WebServlet("/getNeracaPercobaanBulanan")
public class NeracaPercobaanBulanan extends ReportServlet {
	...
	public NeracaPercobaanBulanan() {
		super("NeracaPercobaanBulanan");
	}
