...
@WebServlet("/getLabaRugiPerbandinganXls")
public class LabaRugiPerbandinganXls extends ReportServlet {
	...
	public LabaRugiPerbandinganXls() {
		super("LabaRugiPerbandinganXls");
		setType(2);
	}
