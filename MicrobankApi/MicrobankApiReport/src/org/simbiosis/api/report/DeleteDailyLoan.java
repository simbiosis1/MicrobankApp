...
@WebServlet("/deleteDailyLoan")
public class DeleteDailyLoan extends WebApiReportServlet {
	...
	String processData(String key, String data) {
		...
		if (user != null) {
			...
			iLoanReport.deleteDailyLoan(user.getCompany(), date);
		}
		return "";
	}
}
