...
DIRNAME=`dirname "$0"`
PROGNAME=`basename "$0"`
APP_JAR=CliDeposit.jar
APP_CLASS=org.simbiosis.cli.deposit.AroCorrection
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/MicrobankDto.jar:$APP_HOME/simbiosis/Utils.jar:$APP_HOME/simbiosis/WebApiClient.jar"
