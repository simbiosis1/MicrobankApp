...
@WebServlet("/getSavingTransIdByRef")
public class GetSavingTransIdByRef extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetSavingTransIdByRef() {
		super();
	}
	...
	String processData(String key, String data) {
		...
		if (user != null) {
			...
			Long id = iSavingBp.isSavingTransExist(user.getCompany(), branch,
					refId);
			result = id.toString();
		}
		return result;
