...
public class FindGuarantee extends Composite {

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	interface MyUiBinder extends UiBinder<Widget, FindGuarantee> {
	}

	@UiField
	GuaranteeListEditor searchEditor;
	@UiField
	CheckBox hasCode;
	@UiField
	CheckBox hasName;
