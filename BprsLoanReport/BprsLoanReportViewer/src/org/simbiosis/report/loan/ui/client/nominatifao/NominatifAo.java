...
public class NominatifAo extends FormWidget implements INominatifAo {

	Activity activity;

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	interface MyUiBinder extends UiBinder<Widget, NominatifAo> {
	}
	...
	public void exportReport() {
		createReport("getLoanNominatifAoXls", true);
	}

	@Override
	public void loadReport() {
		createReport("getLoanNominatifAoSummary", false);
	}
