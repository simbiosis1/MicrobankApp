...
APP_CLASS=org.simbiosis.cli.nominatif.creator.CreatorCorrection
GREP="grep"
...
SIMBIOSIS="$APP_HOME/simbiosis/MicrobankDto.jar:$APP_HOME/simbiosis/GlDto.jar:$APP_HOME/simbiosis/Utils.jar:$APP_HOME/simbiosis/WebApiClient.jar"
