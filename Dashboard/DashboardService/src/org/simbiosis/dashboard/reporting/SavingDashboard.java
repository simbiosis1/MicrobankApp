...
@WebServlet("/getSavingDashboard")
public class SavingDashboard extends ReportServlet {
	...
	public SavingDashboard() {
		super("SavingDashboard1");
	}

	List<DashboardDv> prepareData() {
