...
@WebServlet("/saveCashTellerTrans")
public class SaveCashTellerTrans extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SaveCashTellerTrans() {
		super();
	}
	...
	String processData(String key, String data) {
		...
		try {
			...
			iTellerBp.saveGlCashTellerTrans(key, transDto);
		} catch (IOException e) {
			e.printStackTrace();
		}
		return result;
