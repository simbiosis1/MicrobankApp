...
@WebServlet("/listSumGlTransUntilDate")
public class ListSumGlTransUntilDate extends WebApiCoreServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ListSumGlTransUntilDate() {
		super();
	}
	...
	String processData(String key, String data) {
		...
		if (user != null) {
			...
			try {
				...
				List<Object[]> datas = iLedger.listSumGlTransUntilDate(
